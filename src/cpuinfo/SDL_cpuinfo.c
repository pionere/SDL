...
#if defined(SDL_ALTIVEC_INTRINSICS) && defined(HAVE_SETJMP) && !defined(__MACOSX__) && !defined(__OpenBSD__) && !defined(__FreeBSD__) && !(defined(__LINUX__) && defined(HAVE_GETAUXVAL))
