...
#define NGAGE_RENDERDRIVER       RENDERDRIVER_INSTANCE(NGAGE_RenderDriver)
#define NGAGE_RENDERDRIVER_ENUM  SDL_RENDERDRIVER_NGAGE,
#define NGAGE_RENDERDRIVER_ENTRY &NGAGE_RenderDriver,
#else
#define NGAGE_RENDERDRIVER
#define NGAGE_RENDERDRIVER_ENUM
#define NGAGE_RENDERDRIVER_ENTRY
#endif
