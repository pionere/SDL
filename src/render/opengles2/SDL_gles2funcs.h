...
SDL_PROC_UNUSED(void, glShaderBinary, (GLsizei, const GLuint *, GLenum, const void *, GLsizei))
#ifdef __NACL__
...
SDL_PROC_UNUSED(void, glUniform4f, (GLint, GLfloat, GLfloat, GLfloat, GLfloat))
...
SDL_PROC_UNUSED(GLint, glGetAttribLocation, (GLuint, const GLchar *))
SDL_PROC_UNUSED(void, glGetProgramInfoLog, (GLuint, GLsizei, GLsizei *, GLchar *))
