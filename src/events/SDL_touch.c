...
void SDL_SendTouch(SDL_TouchID id, SDL_FingerID fingerid, SDL_Window *window,
                ...
                if (window) {
                    if (down) {
                        if (finger_touching == SDL_FALSE) {
                            int pos_x = (int)(x * (float)window->wrect.w);
                            int pos_y = (int)(y * (float)window->wrect.h);
                            if (pos_x < 0) {
                                pos_x = 0;
                            }
                            if (pos_x > window->wrect.w - 1) {
                                pos_x = window->wrect.w - 1;
                            }
                            if (pos_y < 0) {
                                pos_y = 0;
                            }
                            if (pos_y > window->wrect.h - 1) {
                                pos_y = window->wrect.h - 1;
                            }
