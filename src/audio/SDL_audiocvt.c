...
#ifdef HAVE_SSE_INTRINSICS
static int SDL_ResampleAudio_SSE(const Uint8 channels, const int inrate, const int outrate,
                             const float *inbuffer, const int inframes,
                             float *outbuffer, const int outframes)
{
    const int chans = channels;
...
#ifdef HAVE_SSE_INTRINSICS
static int SDL_ResampleAudio_Mono_SSE(const Uint8 channels, const int inrate, const int outrate,
                             const float *inbuffer, const int inframes,
                             float *outbuffer, const int outframes)
{
    /* This function uses integer arithmetics to avoid precision loss caused
...
#ifdef HAVE_SSE_INTRINSICS
static int SDL_ResampleAudio_Stereo_SSE(const Uint8 channels, const int inrate, const int outrate,
                             const float *inbuffer, const int inframes,
                             float *outbuffer, const int outframes)
{
    const int chans = 2;
...
#ifdef HAVE_SSE_INTRINSICS
    if (SDL_HasSSE()) {
        resampler_mono = SDL_ResampleAudio_Mono_SSE;
        resampler_stereo = SDL_ResampleAudio_Stereo_SSE;
        resampler_generic = SDL_ResampleAudio_SSE;
    }
#endif
}
