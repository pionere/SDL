...
static JNINativeMethod SDLControllerManager_tab[] = {
    ...
    { "nativeAddJoystick", "(ILjava/lang/String;Ljava/lang/String;IIIIIII)I", SDL_JAVA_CONTROLLER_INTERFACE(nativeAddJoystick) },
    ...
    jint button_mask, jint naxes, jint axis_mask, jint nhats, jint nballs)
{
    ...
    retval = Android_AddJoystick(device_id, name, desc, vendor_id, product_id, button_mask, naxes, axis_mask, nhats, nballs);
