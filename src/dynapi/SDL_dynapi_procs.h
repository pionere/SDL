...
SDL_DYNAPI_PROC(int,SDL_LowerBlit,(SDL_Surface *a, const SDL_Rect *b, SDL_Surface *c, const SDL_Rect *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(int,SDL_LowerBlitScaled,(SDL_Surface *a, const SDL_Rect *b, SDL_Surface *c, const SDL_Rect *d),(a,b,c,d),return)
