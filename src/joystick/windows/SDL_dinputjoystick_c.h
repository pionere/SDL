...
extern Uint32 SDL_DINPUT_JoystickGetCapabilities(const SDL_Joystick *joystick);
...
extern int SDL_DINPUT_GetSteamVirtualGamepadSlot(const JoyStick_DeviceData *joystickdevice);
extern int SDL_DINPUT_GetDevicePlayerIndex(const JoyStick_DeviceData *joystickdevice);
