...
extern int SDL_XINPUT_GetSteamVirtualGamepadSlot(JoyStick_DeviceData *joystickdevice);
extern int SDL_XINPUT_GetDevicePlayerIndex(JoyStick_DeviceData *joystickdevice);
