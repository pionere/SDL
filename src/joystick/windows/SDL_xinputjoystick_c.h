...
extern Uint32 SDL_XINPUT_JoystickGetCapabilities(const SDL_Joystick *joystick);
...
extern int SDL_XINPUT_GetSteamVirtualGamepadSlot(const JoyStick_DeviceData *joystickdevice);
extern int SDL_XINPUT_GetDevicePlayerIndex(const JoyStick_DeviceData *joystickdevice);
