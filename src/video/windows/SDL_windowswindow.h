...
typedef struct
{
    ...
    SDL_boolean initializing;
    SDL_boolean expected_resize;
    SDL_boolean in_border_change;
    SDL_boolean in_title_click;
    Uint8 focus_click_pending;
    SDL_boolean skip_update_clipcursor;
    Uint32 last_updated_clipcursor;
    SDL_boolean mouse_relative_mode_center;
    SDL_boolean windowed_mode_was_maximized;
    SDL_boolean in_window_deactivation;
...
extern void WIN_ClientPointToSDL(const SDL_Window *window, POINT *point);
