...
#define PS4_BOOTSTRAP       BOOTSTRAP_INSTANCE(PS4_bootstrap)
#define PS4_BOOTSTRAP_ENUM  SDL_VIDEODRIVER_PS4,
#define PS4_BOOTSTRAP_ENTRY &PS4_bootstrap,
#define PS4_MSGBOX_ENTRY    NULL,
#else
#define PS4_BOOTSTRAP
#define PS4_BOOTSTRAP_ENUM
#define PS4_BOOTSTRAP_ENTRY
#define PS4_MSGBOX_ENTRY
#endif
#ifdef SDL_VIDEO_DRIVER_PS5
#define PS5_BOOTSTRAP       BOOTSTRAP_INSTANCE(PS5_bootstrap)
#define PS5_BOOTSTRAP_ENUM  SDL_VIDEODRIVER_PS5,
#define PS5_BOOTSTRAP_ENTRY &PS5_bootstrap,
#define PS5_MSGBOX_ENTRY    NULL,
#else
#define PS5_BOOTSTRAP
#define PS5_BOOTSTRAP_ENUM
#define PS5_BOOTSTRAP_ENTRY
#define PS5_MSGBOX_ENTRY
#endif
...
#define SWITCH_BOOTSTRAP       BOOTSTRAP_INSTANCE(SWITCH_bootstrap)
#define SWITCH_BOOTSTRAP_ENUM  SDL_VIDEODRIVER_SWITCH,
#define SWITCH_BOOTSTRAP_ENTRY &SWITCH_bootstrap,
#define SWITCH_MSGBOX_ENTRY    NULL,
#else
#define SWITCH_BOOTSTRAP
#define SWITCH_BOOTSTRAP_ENUM
#define SWITCH_BOOTSTRAP_ENTRY
#define SWITCH_MSGBOX_ENTRY
#endif
#ifdef SDL_VIDEO_DRIVER_XBOX
#define XBOX_BOOTSTRAP       BOOTSTRAP_INSTANCE(XBOX_bootstrap)
#define XBOX_BOOTSTRAP_ENUM  SDL_VIDEODRIVER_XBOX,
#define XBOX_BOOTSTRAP_ENTRY &XBOX_bootstrap,
#define XBOX_MSGBOX_ENTRY    NULL,
#else
#define XBOX_BOOTSTRAP
#define XBOX_BOOTSTRAP_ENUM
#define XBOX_BOOTSTRAP_ENTRY
#define XBOX_MSGBOX_ENTRY
#endif
