...
{
#if (defined(SDL_VIDEO_OPENGL) && defined(__MACOSX__)) || (defined(__IPHONEOS__) && !TARGET_OS_MACCATALYST) || defined(__ANDROID__) || defined(__NACL__) || defined(__SWITCH__) || defined(__HAIKU__) || defined(__EMSCRIPTEN__) || defined(__PSP__) || defined(__PS4__)
...
int SDL_VideoInit(const char *driver_name)
{
    ...
    SDL_assert((current_video.SetPrimarySelectionText == NULL) == (current_video.GetPrimarySelectionText == NULL));
