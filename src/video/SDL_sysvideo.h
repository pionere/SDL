...
struct SDL_VideoDevice
{
     ...
     */
    int (*GetDisplayBounds)(SDL_VideoDisplay *display, SDL_Rect *rect);
     ...
     */
    int (*SetDisplayMode)(SDL_VideoDisplay *display, SDL_DisplayMode *mode);
    ...
    void (*SetWindowAlwaysOnTop) (SDL_Window * window, SDL_bool on_top);
    void (*SetWindowFullscreen) (SDL_Window * window, SDL_VideoDisplay * display, SDL_bool fullscreen);
    ...
    // void (*OnWindowEnter) (SDL_Window *window);
    ...
    void (*SuspendScreenSaver)(SDL_bool suspend);
...
extern void SDL_PrivateSendWakeupEvent(SDL_Window *window);
extern int SDL_PrivateWaitEventTimeout(int timeout);
...
extern void *SDL_GetWindowDisplayDriverData(SDL_Window *window);
...
extern SDL_Window *SDL_GetWindowsOptional(void);
extern void SDL_PrivateGetWindowSizeInPixels(SDL_Window *window, int *w, int *h);
