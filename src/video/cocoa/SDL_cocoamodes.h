...
extern int Cocoa_GetDisplayDPI(SDL_VideoDisplay * display, float * ddpi, float * hpdi, float * vdpi);
extern int Cocoa_SetDisplayMode(SDL_VideoDisplay * display, SDL_DisplayMode * mode);
extern void Cocoa_QuitModes(void);
