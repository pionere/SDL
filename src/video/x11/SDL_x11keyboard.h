...
extern int X11_InitKeyboard(void);
extern void X11_UpdateKeymap(SDL_bool send_event);
extern void X11_QuitKeyboard(void);
...
extern KeySym X11_KeyCodeToSym(KeyCode, unsigned char group);
