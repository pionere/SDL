...
int HAIKU_CreateWindowFramebuffer(SDL_Window * window,
                                       Uint32 * format,
...
int HAIKU_UpdateWindowFramebuffer(SDL_Window * window,
...
void HAIKU_DestroyWindowFramebuffer(SDL_Window * window) {
    SDL_BWin *bwin = _ToBeWin(window);
