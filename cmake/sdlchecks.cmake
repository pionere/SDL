  ...
  if(FUSIONSOUND)
    ...
    if(PKG_FUSIONSOUND_FOUND)
      ...
      if(FUSIONSOUND_SHARED AND FUSIONSOUND_LIB AND HAVE_SDL_LOADSO)
        ...
        set(HAVE_FUSIONSOUND_SHARED ON)
      else()
      ...
      if(SDL_LIBSAMPLERATE_SHARED)
        ...
        if(NOT HAVE_SDL_LOADSO)
          ...
          if(_samplerate_type STREQUAL "SHARED_LIBRARY")
            set(HAVE_LIBSAMPLERATE_SHARED ON)
            if(WIN32 OR OS2)
    ...
    if(WAYLAND_FOUND)
      ...
      if(SDL_WAYLAND_LIBDECOR)
        ...
        if(PKG_LIBDECOR_FOUND)
            set(HAVE_WAYLAND_LIBDECOR ON)
            set(HAVE_LIBDECOR_H ON)
            ...
            if(SDL_WAYLAND_LIBDECOR_SHARED AND DECOR_0_LIB AND HAVE_SDL_LOADSO)
                set(HAVE_WAYLAND_LIBDECOR_SHARED ON)
...
macro(CheckOpenGL)
  if(SDL_OPENGL)
    check_c_source_compiles("
        #include <GL/gl.h>
        #include <GL/glext.h>
        int main(int argc, char** argv) { return 0; }" HAVE_OPENGL_GL)
    if(HAVE_OPENGL_GL)
      set(HAVE_OPENGL ON)
      set(SDL_VIDEO_OPENGL 1)
      if(SDL_RENDER_GL)
        set(HAVE_RENDER_GL ON)
