...
int audio_resampleLoss()
{
  ...
  struct test_spec_t {
    ...
    { 50, 440,  0,      22050, 96000, 1, 60, 0.0110 },
    { 50, 440,  M_PI,   22050, 96000, 1, 60, 0.0110 },
    { 50, 440,  0,      11025, 96000, 1, 60, 0.0250 },
    { 50, 440,  M_PI,   11025, 96000, 1, 60, 0.0250 },
    { 250, 440, 0,      48000, 22050, 1, 75, 0.0015 },
    { 250, 440, 0,      48000, 22050, 2, 75, 0.0015 },
    { 50, 5000, 0,      48000, 22050, 1, 65, 0.0050 },
    { 50, 5000, 0,      96000, 22050, 1, 70, 0.0015 },
    { 50, 440,  0,      20000, 10000, 1, 55, 0.0015 },
