...
#else
                        SDLTest_AssertCheck(result->colors[i].r == 0, "Verify value of result.colors[%d].r; expected: 0, got %u", i, result->colors[i].r);
                        SDLTest_AssertCheck(result->colors[i].g == 0, "Verify value of result.colors[%d].g; expected: 0, got %u", i, result->colors[i].g);
                        SDLTest_AssertCheck(result->colors[i].b == 0, "Verify value of result.colors[%d].b; expected: 0, got %u", i, result->colors[i].b);
#endif
                    }
                }
            }
