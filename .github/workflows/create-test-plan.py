...
JOB_SPECS = {
    "msys2-mingw32": JobSpec(name="Windows (msys2, mingw32)",               os=JobOs.Windows2022,       platform=SdlPlatform.Msys2,       artifact="SDL-mingw32",            msys2_platform=Msys2Platform.Mingw32, ),
...
def spec_to_job(spec: JobSpec, key: str, trackmem_symbol_names: bool) -> JobDetails:
    ...
    match spec.platform:
        ...
        case SdlPlatform.Ps4:
            ...
            job.cmake_toolchain_file = "/opt/pacbrew/ps4/openorbis/cmake/ps4.cmake"
            job.run_tests = False
            job.shared = False
            job.static_lib = StaticLibType.A
        ...
        case SdlPlatform.Switch:
            job.shared = False
            job.apt_packages = ["cmake", "autoconf"]
            job.build_tests = False
            job.run_tests = False
            job.test_pkg_config = False
